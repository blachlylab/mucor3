...
public:
    ...
    //
    void Init(
        ulong seed1,       // any 64-bit value will do, including 0
    ...
    //
    void Final(
        ulong *hash1,    // out only: first 64 bits of hash value.
    ...
    //
    pragma(inline, true)
    static ulong Rot64(ulong x, int k)
    {
        return (x << k) | (x >> (64 - k));
    }
    ...
    //
    pragma(inline, true)
    static void ShortMix(ref ulong h0, ref ulong h1, ref ulong h2, ref ulong h3)
    {
