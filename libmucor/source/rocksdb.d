...
rocksdb_t* rocksdb_open_for_read_only(const(rocksdb_options_t)* options,
        const(char)* name, ubyte error_if_wal_file_exists, char** errptr);

rocksdb_t* rocksdb_open_as_secondary(const(rocksdb_options_t)* options,
        const(char)* name, const(char)* secondary_path, char** errptr);

rocksdb_backup_engine_t* rocksdb_backup_engine_open(
        const(rocksdb_options_t)* options, const(char)* path, char** errptr);

rocksdb_backup_engine_t* rocksdb_backup_engine_open_opts(const(
        rocksdb_backup_engine_options_t)* options, rocksdb_env_t* env, char** errptr);
...
void rocksdb_backup_engine_create_new_backup_flush(rocksdb_backup_engine_t* be,
        rocksdb_t* db, ubyte flush_before_backup, char** errptr);

void rocksdb_backup_engine_purge_old_backups(rocksdb_backup_engine_t* be,
        uint num_backups_to_keep, char** errptr);
...
void rocksdb_backup_engine_verify_backup(rocksdb_backup_engine_t* be, uint backup_id,
        char** errptr);

void rocksdb_backup_engine_restore_db_from_latest_backup(rocksdb_backup_engine_t* be, const(char)* db_dir,
        const(char)* wal_dir, const(rocksdb_restore_options_t)* restore_options, char** errptr);

void rocksdb_backup_engine_restore_db_from_backup(rocksdb_backup_engine_t* be,
        const(char)* db_dir, const(char)* wal_dir,
        const(rocksdb_restore_options_t)* restore_options, const uint backup_id, char** errptr);
...
long rocksdb_backup_engine_info_timestamp(const(rocksdb_backup_engine_info_t)* info, int index);

uint rocksdb_backup_engine_info_backup_id(const(rocksdb_backup_engine_info_t)* info, int index);

ulong rocksdb_backup_engine_info_size(const(rocksdb_backup_engine_info_t)* info, int index);

uint rocksdb_backup_engine_info_number_files(const(rocksdb_backup_engine_info_t)* info, int index);
...
void rocksdb_backup_engine_options_set_share_table_files(
        rocksdb_backup_engine_options_t* options, ubyte val);

ubyte rocksdb_backup_engine_options_get_share_table_files(rocksdb_backup_engine_options_t* options);

void rocksdb_backup_engine_options_set_sync(rocksdb_backup_engine_options_t* options, ubyte val);

ubyte rocksdb_backup_engine_options_get_sync(rocksdb_backup_engine_options_t* options);

void rocksdb_backup_engine_options_set_destroy_old_data(
        rocksdb_backup_engine_options_t* options, ubyte val);

ubyte rocksdb_backup_engine_options_get_destroy_old_data(rocksdb_backup_engine_options_t* options);

void rocksdb_backup_engine_options_set_backup_log_files(
        rocksdb_backup_engine_options_t* options, ubyte val);

ubyte rocksdb_backup_engine_options_get_backup_log_files(rocksdb_backup_engine_options_t* options);

void rocksdb_backup_engine_options_set_backup_rate_limit(
        rocksdb_backup_engine_options_t* options, ulong limit);

ulong rocksdb_backup_engine_options_get_backup_rate_limit(rocksdb_backup_engine_options_t* options);

void rocksdb_backup_engine_options_set_restore_rate_limit(
        rocksdb_backup_engine_options_t* options, ulong limit);

ulong rocksdb_backup_engine_options_get_restore_rate_limit(rocksdb_backup_engine_options_t* options);
...
void rocksdb_backup_engine_options_set_callback_trigger_interval_size(
        rocksdb_backup_engine_options_t* options, ulong size);
...
void rocksdb_checkpoint_create(rocksdb_checkpoint_t* checkpoint,
        const(char)* checkpoint_dir, ulong log_size_for_flush, char** errptr);

void rocksdb_checkpoint_object_destroy(rocksdb_checkpoint_t* checkpoint);

rocksdb_t* rocksdb_open_column_families(const(rocksdb_options_t)* options, const(char)* name,
        int num_column_families, const(char*)* column_family_names, const(rocksdb_options_t*)* column_family_options,
        rocksdb_column_family_handle_t** column_family_handles, char** errptr);

rocksdb_t* rocksdb_open_column_families_with_ttl(const(rocksdb_options_t)* options, const(char)* name,
        int num_column_families, const(char*)* column_family_names, const(rocksdb_options_t*)* column_family_options,
        rocksdb_column_family_handle_t** column_family_handles, const(int)* ttls, char** errptr);

rocksdb_t* rocksdb_open_for_read_only_column_families(const(rocksdb_options_t)* options, const(char)* name,
        int num_column_families, const(char*)* column_family_names, const(rocksdb_options_t*)* column_family_options,
        rocksdb_column_family_handle_t** column_family_handles,
        ubyte error_if_wal_file_exists, char** errptr);

rocksdb_t* rocksdb_open_as_secondary_column_families(const(rocksdb_options_t)* options, const(char)* name,
        const(char)* secondary_path, int num_column_families,
        const(char*)* column_family_names, const(rocksdb_options_t*)* column_family_options,
        rocksdb_column_family_handle_t** column_family_handles, char** errptr);

char** rocksdb_list_column_families(const(rocksdb_options_t)* options,
        const(char)* name, size_t* lencf, char** errptr);

void rocksdb_list_column_families_destroy(char** list, size_t len);

rocksdb_column_family_handle_t* rocksdb_create_column_family(rocksdb_t* db,
        const(rocksdb_options_t)* column_family_options,
        const(char)* column_family_name, char** errptr);

rocksdb_column_family_handle_t* rocksdb_create_column_family_with_ttl(rocksdb_t* db,
        const(rocksdb_options_t)* column_family_options,
        const(char)* column_family_name, int ttl, char** errptr);

void rocksdb_drop_column_family(rocksdb_t* db,
        rocksdb_column_family_handle_t* handle, char** errptr);
...
void rocksdb_delete_range_cf(rocksdb_t* db, const(rocksdb_writeoptions_t)* options,
        rocksdb_column_family_handle_t* column_family, const(char)* start_key,
        size_t start_key_len, const(char)* end_key, size_t end_key_len, char** errptr);
...
void rocksdb_multi_get(rocksdb_t* db, const(rocksdb_readoptions_t)* options,
        size_t num_keys, const(char*)* keys_list, const(size_t)* keys_list_sizes,
        char** values_list, size_t* values_list_sizes, char** errs);

void rocksdb_multi_get_cf(rocksdb_t* db, const(rocksdb_readoptions_t)* options,
        const(rocksdb_column_family_handle_t*)* column_families, size_t num_keys, const(char*)* keys_list,
...
//                modified
void rocksdb_batched_multi_get_cf(rocksdb_t* db, const(rocksdb_readoptions_t)* options,
...
ubyte rocksdb_key_may_exist(rocksdb_t* db, const(rocksdb_readoptions_t)* options,
        const(char)* key, size_t key_len, char** value, size_t* val_len,
        const(char)* timestamp, size_t timestamp_len, ubyte* value_found);

// The value is only allocated (using malloc) and returned if it is found and
// value_found isn't NULL. In that case the user is responsible for freeing it.
ubyte rocksdb_key_may_exist_cf(rocksdb_t* db, const(rocksdb_readoptions_t)* options,
        rocksdb_column_family_handle_t* column_family, const(char)* key, size_t key_len, char** value,
        size_t* val_len, const(char)* timestamp, size_t timestamp_len, ubyte* value_found);

rocksdb_iterator_t* rocksdb_create_iterator(rocksdb_t* db, const(rocksdb_readoptions_t)* options);

rocksdb_wal_iterator_t* rocksdb_get_updates_since(rocksdb_t* db,
        ulong seq_number, const(rocksdb_wal_readoptions_t)* options, char** errptr);

rocksdb_iterator_t* rocksdb_create_iterator_cf(rocksdb_t* db,
        const(rocksdb_readoptions_t)* options, rocksdb_column_family_handle_t* column_family);
...
int rocksdb_property_int_cf(rocksdb_t* db,
        rocksdb_column_family_handle_t* column_family, const(char)* propname, ulong* out_val);

char* rocksdb_property_value_cf(rocksdb_t* db,
        rocksdb_column_family_handle_t* column_family, const(char)* propname);

void rocksdb_approximate_sizes(rocksdb_t* db, int num_ranges, const(char*)* range_start_key,
        const(size_t)* range_start_key_len, const(char*)* range_limit_key,
        const(size_t)* range_limit_key_len, ulong* sizes, char** errptr);

void rocksdb_approximate_sizes_cf(rocksdb_t* db, rocksdb_column_family_handle_t* column_family, int num_ranges,
        const(char*)* range_start_key, const(size_t)* range_start_key_len, const(char*)* range_limit_key,
        const(size_t)* range_limit_key_len, ulong* sizes, char** errptr);
...
void rocksdb_compact_range_cf(rocksdb_t* db, rocksdb_column_family_handle_t* column_family,
...
void rocksdb_compact_range_cf_opt(rocksdb_t* db,
        rocksdb_column_family_handle_t* column_family, rocksdb_compactoptions_t* opt,
        const(char)* start_key, size_t start_key_len, const(char)* limit_key, size_t limit_key_len);
...
void rocksdb_destroy_db(const(rocksdb_options_t)* options, const(char)* name, char** errptr);

void rocksdb_repair_db(const(rocksdb_options_t)* options, const(char)* name, char** errptr);
...
rocksdb_writebatch_t* rocksdb_writebatch_create_from(const(char)* rep, size_t size);
...
void rocksdb_writebatch_put(rocksdb_writebatch_t*, const(char)* key,
        size_t klen, const(char)* val, size_t vlen);
void rocksdb_writebatch_put_cf(rocksdb_writebatch_t*, rocksdb_column_family_handle_t* column_family,
        const(char)* key, size_t klen, const(char)* val, size_t vlen);
void rocksdb_writebatch_putv(rocksdb_writebatch_t* b, int num_keys,
        const(char*)* keys_list, const(size_t)* keys_list_sizes, int num_values,
        const(char*)* values_list, const(size_t)* values_list_sizes);
void rocksdb_writebatch_putv_cf(rocksdb_writebatch_t* b, rocksdb_column_family_handle_t* column_family, int num_keys,
        const(char*)* keys_list, const(size_t)* keys_list_sizes, int num_values,
        const(char*)* values_list, const(size_t)* values_list_sizes);
void rocksdb_writebatch_merge(rocksdb_writebatch_t*, const(char)* key,
        size_t klen, const(char)* val, size_t vlen);
void rocksdb_writebatch_merge_cf(rocksdb_writebatch_t*, rocksdb_column_family_handle_t* column_family,
        const(char)* key, size_t klen, const(char)* val, size_t vlen);
void rocksdb_writebatch_mergev(rocksdb_writebatch_t* b, int num_keys,
        const(char*)* keys_list, const(size_t)* keys_list_sizes, int num_values,
        const(char*)* values_list, const(size_t)* values_list_sizes);
void rocksdb_writebatch_mergev_cf(rocksdb_writebatch_t* b, rocksdb_column_family_handle_t* column_family, int num_keys,
        const(char*)* keys_list, const(size_t)* keys_list_sizes, int num_values,
        const(char*)* values_list, const(size_t)* values_list_sizes);
void rocksdb_writebatch_delete(rocksdb_writebatch_t*, const(char)* key, size_t klen);
void rocksdb_writebatch_singledelete(rocksdb_writebatch_t* b, const(char)* key, size_t klen);
void rocksdb_writebatch_delete_cf(rocksdb_writebatch_t*,
        rocksdb_column_family_handle_t* column_family, const(char)* key, size_t klen);
void rocksdb_writebatch_singledelete_cf(rocksdb_writebatch_t* b,
        rocksdb_column_family_handle_t* column_family, const(char)* key, size_t klen);
void rocksdb_writebatch_deletev(rocksdb_writebatch_t* b, int num_keys,
        const(char*)* keys_list, const(size_t)* keys_list_sizes);
void rocksdb_writebatch_deletev_cf(rocksdb_writebatch_t* b, rocksdb_column_family_handle_t* column_family,
        int num_keys, const(char*)* keys_list, const(size_t)* keys_list_sizes);
void rocksdb_writebatch_delete_range(rocksdb_writebatch_t* b, const(char)* start_key,
        size_t start_key_len, const(char)* end_key, size_t end_key_len);
void rocksdb_writebatch_delete_range_cf(rocksdb_writebatch_t* b, rocksdb_column_family_handle_t* column_family,
        const(char)* start_key, size_t start_key_len, const(char)* end_key, size_t end_key_len);
void rocksdb_writebatch_delete_rangev(rocksdb_writebatch_t* b, int num_keys, const(char*)* start_keys_list,
        const(size_t)* start_keys_list_sizes, const(char*)* end_keys_list,
        const(size_t)* end_keys_list_sizes);
void rocksdb_writebatch_delete_rangev_cf(rocksdb_writebatch_t* b,
        rocksdb_column_family_handle_t* column_family, int num_keys,
        const(char*)* start_keys_list, const(size_t)* start_keys_list_sizes,
        const(char*)* end_keys_list, const(size_t)* end_keys_list_sizes);
void rocksdb_writebatch_put_log_data(rocksdb_writebatch_t*, const(char)* blob, size_t len);
void rocksdb_writebatch_iterate(rocksdb_writebatch_t*, void* state,
...
void rocksdb_writebatch_rollback_to_save_point(rocksdb_writebatch_t*, char** errptr);
void rocksdb_writebatch_pop_save_point(rocksdb_writebatch_t*, char** errptr);

/* Write batch with index */

rocksdb_writebatch_wi_t* rocksdb_writebatch_wi_create(size_t reserved_bytes, ubyte overwrite_keys);
rocksdb_writebatch_wi_t* rocksdb_writebatch_wi_create_from(const(char)* rep, size_t size);
...
void rocksdb_writebatch_wi_put(rocksdb_writebatch_wi_t*, const(char)* key,
        size_t klen, const(char)* val, size_t vlen);
void rocksdb_writebatch_wi_put_cf(rocksdb_writebatch_wi_t*, rocksdb_column_family_handle_t* column_family,
        const(char)* key, size_t klen, const(char)* val, size_t vlen);
void rocksdb_writebatch_wi_putv(rocksdb_writebatch_wi_t* b, int num_keys,
        const(char*)* keys_list, const(size_t)* keys_list_sizes, int num_values,
        const(char*)* values_list, const(size_t)* values_list_sizes);
void rocksdb_writebatch_wi_putv_cf(rocksdb_writebatch_wi_t* b,
        rocksdb_column_family_handle_t* column_family, int num_keys,
        const(char*)* keys_list, const(size_t)* keys_list_sizes, int num_values,
        const(char*)* values_list, const(size_t)* values_list_sizes);
void rocksdb_writebatch_wi_merge(rocksdb_writebatch_wi_t*, const(char)* key,
        size_t klen, const(char)* val, size_t vlen);
...
void rocksdb_writebatch_wi_mergev(rocksdb_writebatch_wi_t* b, int num_keys,
        const(char*)* keys_list, const(size_t)* keys_list_sizes, int num_values,
        const(char*)* values_list, const(size_t)* values_list_sizes);
void rocksdb_writebatch_wi_mergev_cf(rocksdb_writebatch_wi_t* b,
        rocksdb_column_family_handle_t* column_family, int num_keys,
        const(char*)* keys_list, const(size_t)* keys_list_sizes, int num_values,
        const(char*)* values_list, const(size_t)* values_list_sizes);
void rocksdb_writebatch_wi_delete(rocksdb_writebatch_wi_t*, const(char)* key, size_t klen);
void rocksdb_writebatch_wi_singledelete(rocksdb_writebatch_wi_t*, const(char)* key, size_t klen);
void rocksdb_writebatch_wi_delete_cf(rocksdb_writebatch_wi_t*,
        rocksdb_column_family_handle_t* column_family, const(char)* key, size_t klen);
void rocksdb_writebatch_wi_singledelete_cf(rocksdb_writebatch_wi_t*,
        rocksdb_column_family_handle_t* column_family, const(char)* key, size_t klen);
void rocksdb_writebatch_wi_deletev(rocksdb_writebatch_wi_t* b, int num_keys,
        const(char*)* keys_list, const(size_t)* keys_list_sizes);
void rocksdb_writebatch_wi_deletev_cf(rocksdb_writebatch_wi_t* b, rocksdb_column_family_handle_t* column_family,
        int num_keys, const(char*)* keys_list, const(size_t)* keys_list_sizes);
...
void rocksdb_writebatch_wi_delete_range_cf(rocksdb_writebatch_wi_t* b, rocksdb_column_family_handle_t* column_family,
        const(char)* start_key, size_t start_key_len, const(char)* end_key, size_t end_key_len);
...
void rocksdb_writebatch_wi_delete_rangev_cf(rocksdb_writebatch_wi_t* b,
        rocksdb_column_family_handle_t* column_family, int num_keys,
        const(char*)* start_keys_list, const(size_t)* start_keys_list_sizes,
        const(char*)* end_keys_list, const(size_t)* end_keys_list_sizes);
void rocksdb_writebatch_wi_put_log_data(rocksdb_writebatch_wi_t*, const(char)* blob, size_t len);
void rocksdb_writebatch_wi_iterate(rocksdb_writebatch_wi_t* b, void* state,
        void function(void*, const(char)* k, size_t klen, const(char)* v, size_t vlen) put,
        void function(void*, const(char)* k, size_t klen) deleted);
...
void rocksdb_writebatch_wi_rollback_to_save_point(rocksdb_writebatch_wi_t*, char** errptr);
char* rocksdb_writebatch_wi_get_from_batch(rocksdb_writebatch_wi_t* wbwi,
        const(rocksdb_options_t)* options, const(char)* key, size_t keylen,
        size_t* vallen, char** errptr);
char* rocksdb_writebatch_wi_get_from_batch_cf(rocksdb_writebatch_wi_t* wbwi, const(rocksdb_options_t)* options,
        rocksdb_column_family_handle_t* column_family, const(char)* key,
        size_t keylen, size_t* vallen, char** errptr);
char* rocksdb_writebatch_wi_get_from_batch_and_db(rocksdb_writebatch_wi_t* wbwi, rocksdb_t* db,
        const(rocksdb_readoptions_t)* options, const(char)* key, size_t keylen,
        size_t* vallen, char** errptr);
char* rocksdb_writebatch_wi_get_from_batch_and_db_cf(rocksdb_writebatch_wi_t* wbwi,
        rocksdb_t* db, const(rocksdb_readoptions_t)* options,
        rocksdb_column_family_handle_t* column_family, const(char)* key,
        size_t keylen, size_t* vallen, char** errptr);
void rocksdb_write_writebatch_wi(rocksdb_t* db, const(rocksdb_writeoptions_t)* options,
        rocksdb_writebatch_wi_t* wbwi, char** errptr);
rocksdb_iterator_t* rocksdb_writebatch_wi_create_iterator_with_base(
        rocksdb_writebatch_wi_t* wbwi, rocksdb_iterator_t* base_iterator);
rocksdb_iterator_t* rocksdb_writebatch_wi_create_iterator_with_base_cf(rocksdb_writebatch_wi_t* wbwi,
...
void rocksdb_block_based_options_set_metadata_block_size(
        rocksdb_block_based_table_options_t* options, ulong metadata_block_size);
void rocksdb_block_based_options_set_partition_filters(
        rocksdb_block_based_table_options_t* options, ubyte partition_filters);
void rocksdb_block_based_options_set_use_delta_encoding(
        rocksdb_block_based_table_options_t* options, ubyte use_delta_encoding);
void rocksdb_block_based_options_set_filter_policy(
        rocksdb_block_based_table_options_t* options, rocksdb_filterpolicy_t* filter_policy);
void rocksdb_block_based_options_set_no_block_cache(
        rocksdb_block_based_table_options_t* options, ubyte no_block_cache);
...
void rocksdb_block_based_options_set_block_cache_compressed(
        rocksdb_block_based_table_options_t* options, rocksdb_cache_t* block_cache_compressed);
void rocksdb_block_based_options_set_whole_key_filtering(
        rocksdb_block_based_table_options_t*, ubyte);
...
void rocksdb_block_based_options_set_index_type(rocksdb_block_based_table_options_t*, int); // uses one of the above enums
enum
{
...
void rocksdb_block_based_options_set_pin_top_level_index_and_filter(
        rocksdb_block_based_table_options_t*, ubyte);
void rocksdb_options_set_block_based_table_factory(rocksdb_options_t* opt,
...
void rocksdb_cuckoo_options_set_hash_ratio(rocksdb_cuckoo_table_options_t* options, double v);
void rocksdb_cuckoo_options_set_max_search_depth(rocksdb_cuckoo_table_options_t* options, uint v);
void rocksdb_cuckoo_options_set_cuckoo_block_size(rocksdb_cuckoo_table_options_t* options, uint v);
void rocksdb_cuckoo_options_set_identity_as_first_hash(
        rocksdb_cuckoo_table_options_t* options, ubyte v);
void rocksdb_cuckoo_options_set_use_module_hash(rocksdb_cuckoo_table_options_t* options, ubyte v);
void rocksdb_options_set_cuckoo_table_factory(rocksdb_options_t* opt,
        rocksdb_cuckoo_table_options_t* table_options);

/* Options */
void rocksdb_set_options(rocksdb_t* db, int count, const(char*)* keys,
        const(char*)* values, char** errptr);

void rocksdb_set_options_cf(rocksdb_t* db, rocksdb_column_family_handle_t* handle,
        int count, const(char*)* keys, const(char*)* values, char** errptr);
...
void rocksdb_options_optimize_for_point_lookup(rocksdb_options_t* opt, ulong block_cache_size_mb);
void rocksdb_options_optimize_level_style_compaction(rocksdb_options_t* opt,
        ulong memtable_memory_budget);
void rocksdb_options_optimize_universal_style_compaction(rocksdb_options_t* opt,
        ulong memtable_memory_budget);
...
void rocksdb_options_set_compression_per_level(rocksdb_options_t* opt,
        const(int)* level_values, size_t num_levels);
...
void rocksdb_options_set_db_paths(rocksdb_options_t*,
        const(rocksdb_dbpath_t*)* path_values, size_t num_paths);
...
void rocksdb_options_set_compression_options(rocksdb_options_t*, int, int, int, int);
void rocksdb_options_set_compression_options_zstd_max_train_bytes(rocksdb_options_t*, int);
int rocksdb_options_get_compression_options_zstd_max_train_bytes(rocksdb_options_t* opt);
void rocksdb_options_set_compression_options_use_zstd_dict_trainer(rocksdb_options_t*, ubyte);
ubyte rocksdb_options_get_compression_options_use_zstd_dict_trainer(rocksdb_options_t* opt);
void rocksdb_options_set_compression_options_parallel_threads(rocksdb_options_t*, int);
int rocksdb_options_get_compression_options_parallel_threads(rocksdb_options_t* opt);
void rocksdb_options_set_compression_options_max_dict_buffer_bytes(rocksdb_options_t*, ulong);
ulong rocksdb_options_get_compression_options_max_dict_buffer_bytes(rocksdb_options_t* opt);
void rocksdb_options_set_bottommost_compression_options(rocksdb_options_t*,
        int, int, int, int, ubyte);
void rocksdb_options_set_bottommost_compression_options_zstd_max_train_bytes(
        rocksdb_options_t*, int, ubyte);
void rocksdb_options_set_bottommost_compression_options_use_zstd_dict_trainer(
        rocksdb_options_t*, ubyte, ubyte);
...
void rocksdb_options_set_level_compaction_dynamic_level_bytes(rocksdb_options_t*, ubyte);
ubyte rocksdb_options_get_level_compaction_dynamic_level_bytes(rocksdb_options_t*);
...
void rocksdb_options_set_skip_stats_update_on_db_open(rocksdb_options_t* opt, ubyte val);
ubyte rocksdb_options_get_skip_stats_update_on_db_open(rocksdb_options_t* opt);
void rocksdb_options_set_skip_checking_sst_file_sizes_on_db_open(rocksdb_options_t* opt, ubyte val);
ubyte rocksdb_options_get_skip_checking_sst_file_sizes_on_db_open(rocksdb_options_t* opt);
...
void rocksdb_options_set_blob_compaction_readahead_size(rocksdb_options_t* opt, ulong val);
ulong rocksdb_options_get_blob_compaction_readahead_size(rocksdb_options_t* opt);
...
void rocksdb_options_set_min_write_buffer_number_to_merge(rocksdb_options_t*, int);
int rocksdb_options_get_min_write_buffer_number_to_merge(rocksdb_options_t*);
void rocksdb_options_set_max_write_buffer_number_to_maintain(rocksdb_options_t*, int);
int rocksdb_options_get_max_write_buffer_number_to_maintain(rocksdb_options_t*);
void rocksdb_options_set_max_write_buffer_size_to_maintain(rocksdb_options_t*, long);
...
size_t rocksdb_options_get_soft_pending_compaction_bytes_limit(rocksdb_options_t* opt);
void rocksdb_options_set_hard_pending_compaction_bytes_limit(rocksdb_options_t* opt, size_t v);
size_t rocksdb_options_get_hard_pending_compaction_bytes_limit(rocksdb_options_t* opt);
...
void rocksdb_options_set_manifest_preallocation_size(rocksdb_options_t*, size_t);
...
void rocksdb_options_set_use_direct_io_for_flush_and_compaction(rocksdb_options_t*, ubyte);
ubyte rocksdb_options_get_use_direct_io_for_flush_and_compaction(rocksdb_options_t*);
...
void rocksdb_options_set_access_hint_on_compaction_start(rocksdb_options_t*, int);
...
void rocksdb_options_set_writable_file_max_buffer_size(rocksdb_options_t*, ulong);
ulong rocksdb_options_get_writable_file_max_buffer_size(rocksdb_options_t*);
void rocksdb_options_set_allow_concurrent_memtable_write(rocksdb_options_t*, ubyte);
ubyte rocksdb_options_get_allow_concurrent_memtable_write(rocksdb_options_t*);
void rocksdb_options_set_enable_write_thread_adaptive_yield(rocksdb_options_t*, ubyte);
ubyte rocksdb_options_get_enable_write_thread_adaptive_yield(rocksdb_options_t*);
void rocksdb_options_set_max_sequential_skip_in_iterations(rocksdb_options_t*, ulong);
ulong rocksdb_options_get_max_sequential_skip_in_iterations(rocksdb_options_t*);
...
void rocksdb_options_set_delete_obsolete_files_period_micros(rocksdb_options_t*, ulong);
ulong rocksdb_options_get_delete_obsolete_files_period_micros(rocksdb_options_t*);
...
void rocksdb_options_set_hash_skip_list_rep(rocksdb_options_t*, size_t, int, int);
void rocksdb_options_set_hash_link_list_rep(rocksdb_options_t*, size_t);
void rocksdb_options_set_plain_table_factory(rocksdb_options_t*, uint, int, double, size_t);
...
void rocksdb_options_set_universal_compaction_options(rocksdb_options_t*,
...
void rocksdb_options_add_compact_on_deletion_collector_factory(rocksdb_options_t*,
        size_t window_size, size_t num_dels_trigger);
...
/* RateLimiter */
rocksdb_ratelimiter_t* rocksdb_ratelimiter_create(long rate_bytes_per_sec,
        long refill_period_us, int fairness);
...
char* rocksdb_perfcontext_report(rocksdb_perfcontext_t* context, ubyte exclude_zero_counters);
...
rocksdb_compactionfilter_t* rocksdb_compactionfilter_create(void* state,
        void function(void*) destructor, ubyte function(void*, int level, const(char)* key,
            size_t key_length, const(char)* existing_value, size_t value_length,
            char** new_value, size_t* new_value_length, ubyte* value_changed) filter,
        const(char)* function(void*) name);
void rocksdb_compactionfilter_set_ignore_snapshots(rocksdb_compactionfilter_t*, ubyte);
void rocksdb_compactionfilter_destroy(rocksdb_compactionfilter_t*);

/* Compaction Filter Context */

ubyte rocksdb_compactionfiltercontext_is_full_compaction(rocksdb_compactionfiltercontext_t* context);
...
rocksdb_compactionfilterfactory_t* rocksdb_compactionfilterfactory_create(
        void* state, void function(void*) destructor, rocksdb_compactionfilter_t* function(void*,
        rocksdb_compactionfiltercontext_t* context) create_compaction_filter,
        const(char)* function(void*) name);
void rocksdb_compactionfilterfactory_destroy(rocksdb_compactionfilterfactory_t*);

/* Comparator */

rocksdb_comparator_t* rocksdb_comparator_create(void* state, void function(
        void*) destructor, int function(void*, const(char)* a, size_t alen,
        const(char)* b, size_t blen) compare, const(char)* function(void*) name);
...
rocksdb_mergeoperator_t* rocksdb_mergeoperator_create(void* state, void function(
        void*) destructor, char* function(void*, const(char)* key, size_t key_length,
        const(char)* existing_value, size_t existing_value_length, const(char*)* operands_list,
        const(size_t)* operands_list_length, int num_operands, ubyte* success,
        size_t* new_value_length) full_merge, char* function(void*, const(char)* key,
        size_t key_length, const(char*)* operands_list, const(size_t)* operands_list_length,
        int num_operands, ubyte* success, size_t* new_value_length) partial_merge, void function(void*,
        const(char)* value, size_t value_length) delete_value, const(char)* function(void*) name);
...
void rocksdb_readoptions_set_iterate_upper_bound(rocksdb_readoptions_t*,
        const(char)* key, size_t keylen);
void rocksdb_readoptions_set_iterate_lower_bound(rocksdb_readoptions_t*,
        const(char)* key, size_t keylen);
...
void rocksdb_readoptions_set_prefix_same_as_start(rocksdb_readoptions_t*, ubyte);
...
void rocksdb_readoptions_set_max_skippable_internal_keys(rocksdb_readoptions_t*, ulong);
ulong rocksdb_readoptions_get_max_skippable_internal_keys(rocksdb_readoptions_t*);
void rocksdb_readoptions_set_background_purge_on_iterator_cleanup(rocksdb_readoptions_t*, ubyte);
ubyte rocksdb_readoptions_get_background_purge_on_iterator_cleanup(rocksdb_readoptions_t*);
void rocksdb_readoptions_set_ignore_range_deletions(rocksdb_readoptions_t*, ubyte);
ubyte rocksdb_readoptions_get_ignore_range_deletions(rocksdb_readoptions_t*);
void rocksdb_readoptions_set_deadline(rocksdb_readoptions_t*, ulong microseconds);
ulong rocksdb_readoptions_get_deadline(rocksdb_readoptions_t*);
void rocksdb_readoptions_set_io_timeout(rocksdb_readoptions_t*, ulong microseconds);
...
void rocksdb_writeoptions_set_ignore_missing_column_families(rocksdb_writeoptions_t*, ubyte);
ubyte rocksdb_writeoptions_get_ignore_missing_column_families(rocksdb_writeoptions_t*);
...
void rocksdb_writeoptions_set_memtable_insert_hint_per_batch(rocksdb_writeoptions_t*, ubyte);
ubyte rocksdb_writeoptions_get_memtable_insert_hint_per_batch(rocksdb_writeoptions_t*);

/* Compact range options */

rocksdb_compactoptions_t* rocksdb_compactoptions_create();
void rocksdb_compactoptions_destroy(rocksdb_compactoptions_t*);
void rocksdb_compactoptions_set_exclusive_manual_compaction(rocksdb_compactoptions_t*, ubyte);
ubyte rocksdb_compactoptions_get_exclusive_manual_compaction(rocksdb_compactoptions_t*);
void rocksdb_compactoptions_set_bottommost_level_compaction(rocksdb_compactoptions_t*, ubyte);
ubyte rocksdb_compactoptions_get_bottommost_level_compaction(rocksdb_compactoptions_t*);
...
rocksdb_memory_allocator_t* rocksdb_jemalloc_nodump_allocator_create(char** errptr);
...
void rocksdb_lru_cache_options_set_memory_allocator(rocksdb_lru_cache_options_t*,
...
void rocksdb_env_set_low_priority_background_threads(rocksdb_env_t* env, int n);
int rocksdb_env_get_low_priority_background_threads(rocksdb_env_t* env);
void rocksdb_env_set_bottom_priority_background_threads(rocksdb_env_t* env, int n);
...
void rocksdb_create_dir_if_missing(rocksdb_env_t* env, const(char)* path, char** errptr);

/* SstFile */

rocksdb_sstfilewriter_t* rocksdb_sstfilewriter_create(
        const(rocksdb_envoptions_t)* env, const(rocksdb_options_t)* io_options);
rocksdb_sstfilewriter_t* rocksdb_sstfilewriter_create_with_comparator(const(rocksdb_envoptions_t)* env,
        const(rocksdb_options_t)* io_options, const(rocksdb_comparator_t)* comparator);
...
void rocksdb_sstfilewriter_file_size(rocksdb_sstfilewriter_t* writer, ulong* file_size);
...
void rocksdb_ingestexternalfileoptions_set_move_files(
        rocksdb_ingestexternalfileoptions_t* opt, ubyte move_files);
void rocksdb_ingestexternalfileoptions_set_snapshot_consistency(
        rocksdb_ingestexternalfileoptions_t* opt, ubyte snapshot_consistency);
void rocksdb_ingestexternalfileoptions_set_allow_global_seqno(
        rocksdb_ingestexternalfileoptions_t* opt, ubyte allow_global_seqno);
void rocksdb_ingestexternalfileoptions_set_allow_blocking_flush(
        rocksdb_ingestexternalfileoptions_t* opt, ubyte allow_blocking_flush);
void rocksdb_ingestexternalfileoptions_set_ingest_behind(
        rocksdb_ingestexternalfileoptions_t* opt, ubyte ingest_behind);
void rocksdb_ingestexternalfileoptions_destroy(rocksdb_ingestexternalfileoptions_t* opt);

void rocksdb_ingest_external_file(rocksdb_t* db, const(char*)* file_list,
        const size_t list_len, const(rocksdb_ingestexternalfileoptions_t)* opt, char** errptr);
void rocksdb_ingest_external_file_cf(rocksdb_t* db, rocksdb_column_family_handle_t* handle, const(char*)* file_list,
        const size_t list_len, const(rocksdb_ingestexternalfileoptions_t)* opt, char** errptr);
...
rocksdb_slicetransform_t* rocksdb_slicetransform_create(void* state, void function(
        void*) destructor, char* function(void*, const(char)* key, size_t length,
        size_t* dst_length) transform, ubyte function(void*, const(char)* key,
        size_t length) in_domain, ubyte function(void*, const(char)* key,
        size_t length) in_range, const(char)* function(void*) name);
...
void rocksdb_fifo_compaction_options_set_max_table_files_size(
        rocksdb_fifo_compaction_options_t* fifo_opts, ulong size);
...
void rocksdb_get_options_from_string(const(rocksdb_options_t)* base_options,
        const(char)* opts_str, rocksdb_options_t* new_options, char** errptr);

void rocksdb_delete_file_in_range(rocksdb_t* db, const(char)* start_key,
        size_t start_key_len, const(char)* limit_key, size_t limit_key_len, char** errptr);

void rocksdb_delete_file_in_range_cf(rocksdb_t* db, rocksdb_column_family_handle_t* column_family,
...
rocksdb_transactiondb_t* rocksdb_transactiondb_open(const(rocksdb_options_t)* options,
        const(rocksdb_transactiondb_options_t)* txn_db_options, const(char)* name, char** errptr);

rocksdb_transactiondb_t* rocksdb_transactiondb_open_column_families(const(
        rocksdb_options_t)* options, const(rocksdb_transactiondb_options_t)* txn_db_options,
        const(char)* name, int num_column_families, const(char*)* column_family_names,
        const(rocksdb_options_t*)* column_family_options,
        rocksdb_column_family_handle_t** column_family_handles, char** errptr);
...
int rocksdb_transactiondb_property_int(rocksdb_transactiondb_t* db,
        const(char)* propname, ulong* out_val);

rocksdb_transaction_t* rocksdb_transaction_begin(rocksdb_transactiondb_t* txn_db,
        const(rocksdb_writeoptions_t)* write_options,
        const(rocksdb_transaction_options_t)* txn_options, rocksdb_transaction_t* old_txn);
...
char* rocksdb_transaction_get(rocksdb_transaction_t* txn, const(rocksdb_readoptions_t)* options,
        const(char)* key, size_t klen, size_t* vlen, char** errptr);

char* rocksdb_transaction_get_cf(rocksdb_transaction_t* txn, const(rocksdb_readoptions_t)* options,
        rocksdb_column_family_handle_t* column_family, const(char)* key,
        size_t klen, size_t* vlen, char** errptr);

char* rocksdb_transaction_get_for_update(rocksdb_transaction_t* txn, const(rocksdb_readoptions_t)* options,
        const(char)* key, size_t klen, size_t* vlen, ubyte exclusive, char** errptr);

char* rocksdb_transaction_get_for_update_cf(rocksdb_transaction_t* txn, const(rocksdb_readoptions_t)* options,
        rocksdb_column_family_handle_t* column_family, const(char)* key,
        size_t klen, size_t* vlen, ubyte exclusive, char** errptr);

char* rocksdb_transactiondb_get(rocksdb_transactiondb_t* txn_db,
        const(rocksdb_readoptions_t)* options, const(char)* key, size_t klen,
        size_t* vlen, char** errptr);

char* rocksdb_transactiondb_get_cf(rocksdb_transactiondb_t* txn_db, const(rocksdb_readoptions_t)* options,
        rocksdb_column_family_handle_t* column_family, const(char)* key,
        size_t keylen, size_t* vallen, char** errptr);
...
void rocksdb_transaction_put_cf(rocksdb_transaction_t* txn, rocksdb_column_family_handle_t* column_family,
        const(char)* key, size_t klen, const(char)* val, size_t vlen, char** errptr);

void rocksdb_transactiondb_put(rocksdb_transactiondb_t* txn_db, const(rocksdb_writeoptions_t)* options,
        const(char)* key, size_t klen, const(char)* val, size_t vlen, char** errptr);

void rocksdb_transactiondb_put_cf(rocksdb_transactiondb_t* txn_db, const(rocksdb_writeoptions_t)* options,
        rocksdb_column_family_handle_t* column_family, const(char)* key,
        size_t keylen, const(char)* val, size_t vallen, char** errptr);

void rocksdb_transactiondb_write(rocksdb_transactiondb_t* txn_db,
        const(rocksdb_writeoptions_t)* options, rocksdb_writebatch_t* batch, char** errptr);

void rocksdb_transaction_merge(rocksdb_transaction_t* txn, const(char)* key,
        size_t klen, const(char)* val, size_t vlen, char** errptr);

void rocksdb_transaction_merge_cf(rocksdb_transaction_t* txn, rocksdb_column_family_handle_t* column_family,
        const(char)* key, size_t klen, const(char)* val, size_t vlen, char** errptr);

void rocksdb_transactiondb_merge(rocksdb_transactiondb_t* txn_db,
        const(rocksdb_writeoptions_t)* options, const(char)* key, size_t klen,
        const(char)* val, size_t vlen, char** errptr);

void rocksdb_transactiondb_merge_cf(rocksdb_transactiondb_t* txn_db, const(rocksdb_writeoptions_t)* options,
        rocksdb_column_family_handle_t* column_family, const(char)* key,
        size_t klen, const(char)* val, size_t vlen, char** errptr);
...
void rocksdb_transaction_delete_cf(rocksdb_transaction_t* txn,
        rocksdb_column_family_handle_t* column_family, const(char)* key,
        size_t klen, char** errptr);

void rocksdb_transactiondb_delete(rocksdb_transactiondb_t* txn_db,
        const(rocksdb_writeoptions_t)* options, const(char)* key, size_t klen, char** errptr);

void rocksdb_transactiondb_delete_cf(rocksdb_transactiondb_t* txn_db, const(rocksdb_writeoptions_t)* options,
        rocksdb_column_family_handle_t* column_family, const(char)* key,
        size_t keylen, char** errptr);

rocksdb_iterator_t* rocksdb_transaction_create_iterator(rocksdb_transaction_t* txn,
        const(rocksdb_readoptions_t)* options);

rocksdb_iterator_t* rocksdb_transaction_create_iterator_cf(rocksdb_transaction_t* txn,
        const(rocksdb_readoptions_t)* options, rocksdb_column_family_handle_t* column_family);

rocksdb_iterator_t* rocksdb_transactiondb_create_iterator(
        rocksdb_transactiondb_t* txn_db, const(rocksdb_readoptions_t)* options);

rocksdb_iterator_t* rocksdb_transactiondb_create_iterator_cf(rocksdb_transactiondb_t* txn_db,
        const(rocksdb_readoptions_t)* options, rocksdb_column_family_handle_t* column_family);
...
rocksdb_transaction_t* rocksdb_optimistictransaction_begin(
        rocksdb_optimistictransactiondb_t* otxn_db, const(rocksdb_writeoptions_t)* write_options,
        const(rocksdb_optimistictransaction_options_t)* otxn_options,
        rocksdb_transaction_t* old_txn);

void rocksdb_optimistictransactiondb_write(rocksdb_optimistictransactiondb_t* otxn_db,
        const(rocksdb_writeoptions_t)* options, rocksdb_writebatch_t* batch, char** errptr);
...
void rocksdb_transactiondb_options_set_max_num_locks(
        rocksdb_transactiondb_options_t* opt, long max_num_locks);
...
void rocksdb_transactiondb_options_set_transaction_lock_timeout(
        rocksdb_transactiondb_options_t* opt, long txn_lock_timeout);

void rocksdb_transactiondb_options_set_default_lock_timeout(
        rocksdb_transactiondb_options_t* opt, long default_lock_timeout);
...
void rocksdb_transaction_options_set_set_snapshot(rocksdb_transaction_options_t* opt, ubyte v);

void rocksdb_transaction_options_set_deadlock_detect(rocksdb_transaction_options_t* opt, ubyte v);

void rocksdb_transaction_options_set_lock_timeout(
        rocksdb_transaction_options_t* opt, long lock_timeout);

void rocksdb_transaction_options_set_expiration(rocksdb_transaction_options_t* opt, long expiration);

void rocksdb_transaction_options_set_deadlock_detect_depth(
        rocksdb_transaction_options_t* opt, long depth);
...
void rocksdb_optimistictransaction_options_set_set_snapshot(
        rocksdb_optimistictransaction_options_t* opt, ubyte v);
...
int rocksdb_optimistictransactiondb_property_int(
        rocksdb_optimistictransactiondb_t* db, const(char)* propname, ulong* out_val);

// referring to convention (3), this should be used by client
// to free memory that was malloc()ed
void rocksdb_free(void* ptr);

rocksdb_pinnableslice_t* rocksdb_get_pinned(rocksdb_t* db,
        const(rocksdb_readoptions_t)* options, const(char)* key, size_t keylen, char** errptr);
rocksdb_pinnableslice_t* rocksdb_get_pinned_cf(rocksdb_t* db, const(rocksdb_readoptions_t)* options,
        rocksdb_column_family_handle_t* column_family, const(char)* key,
        size_t keylen, char** errptr);
...
void rocksdb_memory_consumers_add_db(rocksdb_memory_consumers_t* consumers, rocksdb_t* db);
...
ulong rocksdb_approximate_memory_usage_get_mem_table_total(rocksdb_memory_usage_t* memory_usage);
ulong rocksdb_approximate_memory_usage_get_mem_table_unflushed(rocksdb_memory_usage_t* memory_usage);
ulong rocksdb_approximate_memory_usage_get_mem_table_readers_total(
        rocksdb_memory_usage_t* memory_usage);
ulong rocksdb_approximate_memory_usage_get_cache_total(rocksdb_memory_usage_t* memory_usage);

void rocksdb_options_set_dump_malloc_stats(rocksdb_options_t*, ubyte);

void rocksdb_options_set_memtable_whole_key_filtering(rocksdb_options_t*, ubyte);
