...
unittest {
    ...
    assert(db.iter.map!( x => x[0].idup).array == ["key1", "key2", "key3", "key4", "key5", "key6"]);
    assert(db.iter.retro.map!( x => x[0].idup).array == ["key6", "key5", "key4", "key3", "key2", "key1"]);
    ...
    assert(itr2.retro.map!( x => x[0].idup).array == ["key6", "key5", "key4", "key3"]);
    ...
    assert(db.iter.gt(cast(ubyte[])"key2").map!( x => x[0].idup).array == ["key3", "key4", "key5", "key6"]);
    assert(db.iter.gt(cast(ubyte[])"key2.1").map!( x => x[0].idup).array == ["key3", "key4", "key5", "key6"]);

    assert(db.iter.gte(cast(ubyte[])"key2").map!( x => x[0].idup).array == ["key2", "key3", "key4", "key5", "key6"]);
    assert(db.iter.gte(cast(ubyte[])"key1.5").map!( x => x[0].idup).array == ["key2", "key3", "key4", "key5", "key6"]);
    
    assert(db.iter.lt(cast(ubyte[])"key1").map!( x => x[0].idup).array == []);
    assert(db.iter.lt(cast(ubyte[])"key2").map!( x => x[0].idup).array == ["key1",]);
    assert(db.iter.lt(cast(ubyte[])"key2.1").map!( x => x[0].idup).array == ["key1", "key2"]);
    
    assert(db.iter.lte(cast(ubyte[])"key2").map!( x => x[0].idup).array == ["key1", "key2"]);
    assert(db.iter.lte(cast(ubyte[])"key1.5").map!( x => x[0].idup).array == ["key1"]);
}
